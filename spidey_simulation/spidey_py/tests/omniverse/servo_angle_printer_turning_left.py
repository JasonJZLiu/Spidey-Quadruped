...
if __name__ == "__main__":
    ...
    turn_left_waypoints += CommandGenerator.default_right_ready_state()
    turn_left_waypoints += CommandGenerator.turn_CCW_from_right_move_1()
    turn_left_waypoints += CommandGenerator.turn_CCW_from_right_move_2()
    turn_left_waypoints += CommandGenerator.turn_CCW_from_right_move_3()
    turn_left_waypoints += CommandGenerator.turn_CCW_from_right_move_4()
    turn_left_waypoints += CommandGenerator.turn_CCW_from_right_move_5()

    turn_left_trajectory = interpolate_trajectory(turn_left_waypoints)


    turn_left_joint_cmd = []

    for desired_cmd in turn_left_trajectory:
        ...
        turn_left_joint_cmd.append(spidey_joint_cmd_angle)


    print("\n-------------------------------------------------------\n")
    print(turn_left_joint_cmd)



    filename = 'joint_cmds/turn_left_joint_cmd'
    outfile = open(filename,'wb')
    pickle.dump(turn_left_joint_cmd, outfile)
    outfile.close()